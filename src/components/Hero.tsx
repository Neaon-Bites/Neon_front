  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-500/10 rounded-full blur-[100px] mix-blend-screen"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight mb-6 leading-tight">
              Créez votre site. <br />
              <span className="text-blue-300">Contrôlez votre audience.</span> <br />
              Grandissez.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-4">
              {/* ✅ CORRECTION: Utilise navigate('/cms') et useNavigate */}
              <button
                onClick={handleCreateSite}
                className="w-full sm:w-auto flex items-center justify-center 
                bg-blue-600 text-white hover:bg-blue-700 text-lg px-8 py-4 
                rounded-full font-bold transition-all 
                shadow-[0_10px_40px_-10px_rgba(59,130,246,0.5)] hover:-translate-y-1"
              >
                Créer un site
            ...
            <div className="mt-8 flex items-center justify-center lg:justify-start gap-6 text-sm text-slate-400 font-medium">
              <span className="flex items-center">
                <CheckCircle2 className="w-4 h-4 mr-1.5 text-green-400" /> Pas de carte requise
              </span>
              <span className="flex items-center">
                <CheckCircle2 className="w-4 h-4 mr-1.5 text-green-400" /> 14 jours gratuits
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-lg lg:max-w-none relative">
            <div className="relative animate-float">
              ...
              <div className="relative bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-2 overflow-hidden">
                <img
      ...
      <div className="absolute bottom-0 left-0 w-full translate-y-1">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M0 60L48 68.3C96 76.7 192 93.3 288 95C384 96.7 480 83.3 576 68.3C672 53.3 768 36.7 864 36.7C960 36.7 1056 53.3 1152 65C1248 76.7 1344 83.3 1392 86.7L1440 90V120H1392C1344 120 1248 120 1152 120C1056 120 960 120 864 120C768 120 672 120 576 120C480 120 384 120 288 120C192 120 96 120 48 120H0V60Z"
            fill="#f8fafc"
          />
        </svg>
      </div>
